 ...
 */
public class FmTransactionAddCurrencyExecutor implements CommandExecutor {
        ...
        try {
            ...
            try {
                ...
                if(resultSet.next()) {
                    ...
                    switch(partyType) {
                        case OWNER:
                            tradeTransaction.setOwnerParty(tradeTransaction.getOwnerParty().addCurrency(currency, BigDecimal.valueOf(amount)));
                            break;
                        case CUSTOMER:
                            tradeTransaction.setCustomerParty(tradeTransaction.getCustomerParty().addCurrency(currency, BigDecimal.valueOf(amount)));
                            break;
                    }
