 ...
 */
public class FmQuickShopCreateItemTradeExecutor extends FmQuickShopCreateExecutor {
    ...
    public static CommandSpec create() {
        return CommandSpec.builder()
                ...
                .permission(PluginInfo.DATA_ROOT + ".quickshop.itemtrade")
                .arguments(
                ...
                .executor(new FmQuickShopCreateItemTradeExecutor())
                .build();
    }

    @Override
    protected String getName() {
        return "quickshop itemtrade";
    }
