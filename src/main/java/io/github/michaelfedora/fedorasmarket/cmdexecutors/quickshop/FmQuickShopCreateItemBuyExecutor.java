 ...
 */
public class FmQuickShopCreateItemBuyExecutor extends FmQuickShopCreateExecutor {
    ...
    public static CommandSpec create() {
        return CommandSpec.builder()
                ...
                .permission(PluginInfo.DATA_ROOT + ".quickshop.itembuy")
                .arguments(
                ...
                .executor(new FmQuickShopCreateItemBuyExecutor())
                .build();
    }

    @Override
    protected String getName() {
        return "quickshop itembuy";
    }
